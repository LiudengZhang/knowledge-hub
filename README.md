...
Curated knowledge bases for computational biology — awesome lists with companion sites that go beyond link dumps.

**Site:** [liudengzhang.github.io/knowledge-hub](https://liudengzhang.github.io/knowledge-hub/)
...
Each list is organized around a **thesis** — a point of view about the field — rather than a flat collection of links. The companion MkDocs sites add depth with paper analyses, concept explainers, method comparisons, and synthesis essays.

## Adding a New Project

Edit the `projects` array in `index.html` and update this README.
